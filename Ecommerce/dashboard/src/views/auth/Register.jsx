...
const Register = () => {
    ...
    const submit = (e) => {
        e.preventDefault();
        console.log("Sign up Details: ", state);
    };
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input
                                ...
                                className='px-3 py-2 outline-none border
                                border-slate-700 bg-transparent rounded-md' type='password' 
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input
                                onChange={inputHandle} value={state.confirmPassword}
                                className='px-3 py-2 outline-none border
                                border-slate-700 bg-transparent rounded-md' type='password' 
                        ...
                        <div className='flex items-center w-full gap-3 mb-3'>
                            <input 
                                ...
                                bg-gray-200 rounderd border border-gray-300
                                focus:ring-blue-500' type='checkbox' 
                        ...
                        <div className='flex justify-center items-center gap-3'>
                            <div className='w-[135px] h-[35px] flex rounded-md 
                                bg-orange-700 shadwo-lg hover:shadow-orange-700/50
                                justify-center cursor-pointer items-center overflow-hidden'>
                                    <span><FaGoogle /></span>    
                            </div>
                            <div className='w-[135px] h-[35px] flex rounded-md 
                                bg-blue-700 shadwo-lg hover:shadow-blue-700/50
                                justify-center cursor-pointer items-center overflow-hidden'>
